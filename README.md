...
![WaveSpeed AI supported models list](wavespeed-models-1024x484.jpg)
...
![Detailed usage and billing statistics](wavespeed-cost-1024x376.jpg)

## API Access for Easy Integration

Create API keys for local or remote integration into your applications.

![API interface for remote or local integration](wavespeed-api-1024x345.jpg)
...
![Operate via web interface or desktop client](wavespeed-dashboard-1024x344.jpg)
...
![Support for credit cards, Alipay, WeChat Pay, and PayPal](wavespeed-pay-1024x581.jpg)
